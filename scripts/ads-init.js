...
if(isAdinPlayEnabled())
{
    ...
    adinplayScript.src = "./patch/null.js?//api.adinplay.com/libs/aiptag/pub/SHK/smashkarts.io/tag.min.js";
    ...
    googletag.cmd.push(() =>
    {
            ...
            || url.includes("smashkarts-dev.firebaseapp.com"))
        {
            (function ()
            {
                ...
                afgads.setAttribute("src", "./patch/null.js?pagead2.googlesyndication.com/pagead/js/adsbygoogle.js");
