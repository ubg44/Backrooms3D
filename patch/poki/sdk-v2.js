( () => {
    ...
    !i && !r) {
        ...
        try {
            ...
            localStorage.setItem("poki_events_user_id", u));
            var s = o("game_id")
              , l = o("game_version_id");
            if (!s || !l)
                throw 1;
            ...
            window.PokiSDK.measure = function(e, t, n) {
                (function(e, t, n) {
                    return "game" === e && "loading" === t && "start" === n || "game" === e && "loading" === t && "complete" === n || "game" === e && "launch" === t && "" === n || "tutorial" === e && "start" === t && "" === n || "tutorial" === e && "complete" === t && "" === n || "action" === e && "first" === t && "" === n || "level" === e && "start" === t || "level" === e && "complete" === t || "level" === e && "fail" === t || "rewarded" === e && "visible" === t || "rewarded" === e && "click" === t || "rewarded" === e && "start" === t || "rewarded" === e && "complete" === t || "midroll" === e && "start" === t || "midroll" === e && "complete" === t || "custom" === e
                }
                )(e = "".concat(e), t = void 0 === t ? "" : "".concat(t), n = void 0 === n ? "" : "".concat(n)) && (window.pokiMeasureBuildin = !0,
    ...
    var f = function() {
        var e = window.pokiSDKVersion || o("ab") || "01e6a638630e4f964ccca605ec26f835710cdfa1"
          , t = "sdk-core-".concat(e, ".js");
        r && (t = "sdk-kids-".concat(e, ".js")),
        i && (t = "sdk-playground-".concat(e, ".js")),
        a && (t = "sdk-hoist-".concat(e, ".js"));
        new URL(document.currentScript.src);
        // return "https://game-cdn.poki.com/scripts/".concat(e, "/").concat(t)
        return "./patch/poki/". concat(t);
    }()
